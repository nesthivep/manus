...
Interact with a web browser to perform navigation (go_to_url, go_back, web_search), element interaction (click_element, input_text, scroll_down/up, scroll_to_text, send_keys, get_dropdown_options, select_dropdown_option), content extraction (extract_content), tab management (switch_tab, open_tab, close_tab), and utility actions (wait). Use this tool to browse websites, fill forms, click buttons, extract information, and manage browser tabs.
"""
